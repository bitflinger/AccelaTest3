...
/* WTUA */  //var eventName = "WorkflowTaskUpdateAfter";  wfTask = "Pending Approval";	  wfStatus = "Approved";  wfDateMMDDYYYY = "09/17/2015";
...
try {
	showDebug = true;
	//scheduleInspection("Frame",2,"ADMIN","AM","Scheduled via EMSE on ASA");
	//editAppSpecific("Base Flood Elevation",25.7);
